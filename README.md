...
The first live skeleton of the website can be visualized here: [link](https://com-480-data-visualization.github.io/VizLaLune/Milestone2/), whilst its code can be found in its related folder: [link](https://github.com/com-480-data-visualization/VizLaLune/blob/master/Milestone2/index.html).
